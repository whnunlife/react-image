...
import { any, node, bool, string, oneOfType, array, func } from 'prop-types';
  ...
  _createClass(Img, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["container", "loader", "unloader", "src", "decode", "loaderContainer", "unloaderContainer", "mockImage", "imageRef"]); //eslint-disable-line
      ...
      if (this.state.isLoaded) {
        ...
        return container(React.createElement("img", _extends({
          ref: imageRef
        }, imgProps)));
